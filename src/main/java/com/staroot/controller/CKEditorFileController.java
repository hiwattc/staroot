        ...
        if (!file.isEmpty()) {
            try {
                ...
                BufferedOutputStream stream = new BufferedOutputStream(
                        new FileOutputStream(new File(StarootApplication.UPLOAD_DIR_CKEDITOR + "/" + name)));
        ...
        if (files != null && files.length >0) {
            for(int i =0 ;i< files.length; i++){
                try {
                    ...
                    BufferedOutputStream buffStream = new BufferedOutputStream(new FileOutputStream(new File(StarootApplication.UPLOAD_DIR_CKEDITOR + "/" + fileName)));
